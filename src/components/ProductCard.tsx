...
import { FiShoppingCart, FiEdit, FiTrash2, FiHeart, FiEye } from "react-icons/fi";
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
        {!product.inStock ? (
          ...
          <div className="px-4 py-1.5 bg-gradient-to-r from-emerald-500 to-green-500 text-white text-xs font-medium rounded-full shadow-lg backdrop-blur-sm">
            موجود
          </div>
        )}
